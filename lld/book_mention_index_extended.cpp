// Book management system with a character mention index -- extended version.
// The 30-minute core lives in book_mention_index.cpp; this adds mutation,
// co-occurrence, late registration, multi-book counts and locking.
//
// Build: g++ -std=c++17 -O2 -Wall book_mention_index_extended.cpp -o extended
//
// Design notes:
...
int main() {
    ...
    // F9 -- mutation. Counts stay exact; positions follow the shift.
    ...
    // F7 -- register a character after indexing; only that name is scanned.
